...
Register-ArgumentCompleter -Native -CommandName openclaw -ScriptBlock {
    ...
    if ($commandPath -eq "") {
         ...
         $completions | Where-Object { $_ -like "$wordToComplete*" } | ForEach-Object {
            ...
            if ($commandPath -eq 'openclaw voicecall') {
            ...
            if ($commandPath -eq 'openclaw voicecall call') {
            ...
            if ($commandPath -eq 'openclaw voicecall start') {
            ...
            if ($commandPath -eq 'openclaw voicecall continue') {
            ...
            if ($commandPath -eq 'openclaw voicecall speak') {
                $completions = @('--call-id','--message')
                $completions | Where-Object { $_ -like "$wordToComplete*" } | ForEach-Object {
                    [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterName', $_)
                }
            ...
            if ($commandPath -eq 'openclaw voicecall end') {
                $completions = @('--call-id')
                $completions | Where-Object { $_ -like "$wordToComplete*" } | ForEach-Object {
                    [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterName', $_)
                }
            ...
            if ($commandPath -eq 'openclaw voicecall status') {
                $completions = @('--call-id')
                $completions | Where-Object { $_ -like "$wordToComplete*" } | ForEach-Object {
                    [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterName', $_)
                }
            ...
            if ($commandPath -eq 'openclaw voicecall tail') {
            ...
            if ($commandPath -eq 'openclaw voicecall latency') {
            ...
            if ($commandPath -eq 'openclaw voicecall expose') {
