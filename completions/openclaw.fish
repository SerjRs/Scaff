...
complete -c openclaw -n "__fish_seen_subcommand_from list" -l channel -d 'Channel (telegram, whatsapp, discord, irc, googlechat, slack, signal, imessage, msteams, mattermost, nextcloud-talk, feishu, matrix, bluebubbles, zalo, zalouser, synology-chat, nostr, line, twitch)'
...
complete -c openclaw -n "__fish_seen_subcommand_from approve" -l channel -d 'Channel (telegram, whatsapp, discord, irc, googlechat, slack, signal, imessage, msteams, mattermost, nextcloud-talk, feishu, matrix, bluebubbles, zalo, zalouser, synology-chat, nostr, line, twitch)'
