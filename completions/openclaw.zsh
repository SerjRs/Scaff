...
_openclaw_pairing_list() {
  _arguments -C \
    "--channel[Channel (telegram, whatsapp, discord, irc, googlechat, slack, signal, imessage, msteams, mattermost, nextcloud-talk, feishu, matrix, bluebubbles, zalo, zalouser, synology-chat, nostr, line, twitch)]" \
