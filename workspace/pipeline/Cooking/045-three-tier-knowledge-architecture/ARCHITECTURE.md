...
- **On access:** When a fact is returned in search results, traversed, or referenced by the LLM. `hit_count` increments, `last_accessed_at` updates. Score recalculation happens inline.
